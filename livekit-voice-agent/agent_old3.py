...
#ELEVENLABS = os.getenv("SUPABASE_KEY")
...
async def entrypoint(ctx: agents.JobContext):
    try:
        ...
        session = AgentSession(
            ...
            tts="elevenlabs/voice-es:9ba16d54-2937-434f-abe7-66041aa332b7",  # Modelo estable de Eleven Labs
            vad=silero.VAD.load(),
...
if __name__ == "__main__":
    agents.cli.run_app(agents.WorkerOptions(entrypoint_fnc=entrypoint, initialize_process_timeout=120))